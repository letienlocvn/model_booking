...
import 'package:model_booking_project/widgets/card-shopping-cart.dart';

//widgets
import 'package:model_booking_project/widgets/navbar.dart';
import 'package:model_booking_project/widgets/card-shopping.dart';

List<CardShoppingCart> smallCards = [
  CardShoppingCart(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child:
                        Divider(color: MaterialColors.muted.withOpacity(0.7)),
                  ),
                  Column(
